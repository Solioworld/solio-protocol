export const factoryAbi = [
  ...
  },
  {
    ...
    inputs: [{ name: 'bondingCurveType', type: 'string', internalType: 'string' }],
  ...
  },
  {
    ...
    inputs: [{ name: 'newPlatformAdmin', type: 'address', internalType: 'address' }],
    outputs: [],
    stateMutability: 'nonpayable',
  },
  {
  ...
  },
  {
    ...
    inputs: [{ name: 'newPlatformTreasury', type: 'address', internalType: 'address' }],
    outputs: [],
    stateMutability: 'nonpayable',
  },
  {
  ...
  },
  {
    type: 'event',
    name: 'Initialized',
    inputs: [{ name: '', type: 'uint8', indexed: false, internalType: 'uint8' }],
    anonymous: false,
  },
  {
    type: 'event',
